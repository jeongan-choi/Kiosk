...
public class BaseChairSelect extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.base_chair_select);
        ...
        String word1 = "좌석";
        int start = content.indexOf(word1);
        ...
        String word2 = "인원";
        start = content.indexOf(word2);
        end = start + word2.length();
        ...
        TextView adult_count = findViewById(R.id.adult_count);

        Button adult_plus =  findViewById(R.id.adult_plus_button);
        adult_plus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                count_adult++;
                adult_count.setText(count_adult+"");
            }
        });

        Button adult_minus =  findViewById(R.id.adult_minus_button);
        ...
        TextView teen_count = findViewById(R.id.teen_count);

        Button teen_plus =  findViewById(R.id.teen_plus_button);
        teen_plus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                count_teen++;
                teen_count.setText(count_teen+"");
            }
        });

        Button teen_minus =  findViewById(R.id.teen_minus_button);
        teen_minus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                count_teen--;
                teen_count.setText(count_teen+"");
        ...
        // 완료 버튼 클릭시 결제 방식 고르는 화면(base_payment_select.xml)으로 이동
        Button finish_btn = findViewById(R.id.finish_button);
        finish_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), BasePaymentSelect.class);
                startActivity(intent);
            }
        });
